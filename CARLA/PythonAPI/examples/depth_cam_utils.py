...
depth_path = r"/home/reu/carla/PythonAPI/examples/Carla_Recorder/Depth_Recorder" + '/' + status
from config import semantic_path
...
def parse_depth_img(path, depth=True):
    if depth:
        depth_img = depth_path + '/' + path
    else:
        print(semantic_path)
        depth_img = semantic_path + '/' + path
    print(depth_img)
